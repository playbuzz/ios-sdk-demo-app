...
+ (void)activate;
/// Prefetch the library JS files, should be called after the SDK is activated and as early in the application life cycle as possible
...
/// Call this method to toggle Web Content logs on & off, when active the logs will show in the Xcode console
...
/// Call this method to toggle OMID Content logs on & off, when active the logs will show in the Xcode console
...
/// The identifier of the specific player as setup in exco’s dashboard systems
@property (nonatomic, readonly, copy) NSString * _Nonnull playerID;
/// The host application name
/// If not provided via the builder object the system will retrieve it from the applications main bundle
...
/// The visual setup of the mini player used
@property (nonatomic, readonly, copy) NSString * _Nonnull miniPlayer;
@end
...
@property (nonatomic, copy) NSString * _Nonnull miniPlayer;
...
/// A UIView subclass hosting the Exco video player, needs a configuration object to work properly
/// The view can be configured via the @IBInspectable system or via parameters passed in code. For details see:
/// \code
...
/// Use this property to pass the PlayerID value via xib / storyboard IBInspectable mechanism
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibPlayerID;
/// Use this property to pass the Application Name value via xib / storyboard IBInspectable mechanism
/// Note: if you fail to pass a value the SDK will attempt to retrieve the application name from the apps main bundle
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibAppName;
/// Use this property to pass the Application Bundle value via xib / storyboard IBInspectable mechanism
/// Note: if you fail to pass a value the SDK will attempt to retrieve the application bundle identifier from the apps main bundle
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibAppBundle;
/// Use this property to pass the Application Version value via xib / storyboard IBInspectable mechanism
/// Note: if you fail to pass a value the SDK will attempt to retrieve the application ¸version from the apps main bundle
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibAppVersion;
/// Use this property to pass the Application Categories value via xib / storyboard IBInspectable mechanism
/// NOTE: if you need to pass several values concatenate them like so: <code>"one, two, three"</code>
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibCategories;
/// Use this property to pass the Applications Appstore ID value via xib / storyboard IBInspectable mechanism
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibAppstoreID;
/// Use this property to pass the Applications Appstore URL value via xib / storyboard IBInspectable mechanism
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibAppstoreUrl;
/// Use this property to pass the DeviceID value via xib / storyboard IBInspectable mechanism
/// Note: if you fail to pass a value the SDK will attempt to retrieve the devices IDFA, if the application has the right permissions
@property (nonatomic, copy) IBInspectable NSString * _Nullable xibDeviceID;
/// Use this property to pass the DeviceIFA value via xib / storyboard IBInspectable mechanism
...
/// The configuration of the current Exco player associated with the view
/// To change the associated player use the <code>apply(player configuration: ExcoPlayerConfiguration, shouldStore inCache: Bool)</code> method
@property (nonatomic, readonly, strong) id <ExcoPlayerConfigurationProtocol> _Nullable playerConfiguration;
/// Controls whether the associated web video player  is inspectable in Web Inspector (Safari Developer Tools).
@property (nonatomic) BOOL isWebInspectable;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (void)awakeFromNib;
/// Use this method to assign a new Played to the view, based on the passes configuration object
/// Note: Cashed players are retained by the system and will not die until you specifically call on the appropriate <code>ExcoMobileSDK</code> method
/// \param configuration configuration object to be used by the system to associates a new player instance with the view
///
/// \param inCache indicate if the configured player should be retained in the SDK cache mechanism
///
...
@optional
/// This method is called when an instance of <code>ExcoPlayerView</code> has successfully loaded  web content
...
/// Init an instance of the video player
/// \param playerController An object representing the player controller.
///
- (void)playerDidInitIn:(ExcoPlayerView * _Nonnull)playerView;
/// Signals that the player view finished loading its content
/// \param playerView An object representing the player view
///
- (void)playerDidLoadTo:(ExcoPlayerView * _Nonnull)playerView;
/// Signals the desire to begin playback
/// \param playerView An object representing the player view
///
- (void)playerDidStartPlayingIn:(ExcoPlayerView * _Nonnull)playerView;
/// Pauses video playback.
/// \param playerView An object representing the player view
///
- (void)playerDidPauseIn:(ExcoPlayerView * _Nonnull)playerView;
/// Stop and close the video player
/// \param playerView An object representing the player view
///
- (void)playerDidCloseIn:(ExcoPlayerView * _Nonnull)playerView;
/// This method is called when an instance of <code>ExcoPlayerView</code> was muted
/// \param playerView An object representing the player view
///
- (void)playerDidMuteIn:(ExcoPlayerView * _Nonnull)playerView;
/// This method is called when an instance of <code>ExcoPlayerView</code> was unmuted
/// \param playerView An object representing the player view
///
- (void)playerDidUnmuteIn:(ExcoPlayerView * _Nonnull)playerView;
...
/// \param playerController An object representing the player controller.
///
- (void)playerView:(ExcoPlayerView * _Nonnull)playerView playerDidEnterFullscreen:(NSString * _Nonnull)playerID;
/// Called when an instance of <code>ExcoPlayerView</code> exits full screen mode
/// \param playerController An object representing the player controller.
///
- (void)playerView:(ExcoPlayerView * _Nonnull)playerView playerDidExitFullscreen:(NSString * _Nonnull)playerID;
...
/// \param playerID The identifier of the player  that was used
///
- (void)playerView:(ExcoPlayerView * _Nonnull)playerView didClickCTA:(NSString * _Nonnull)playerID;
...
/// \param playerID The identifier of the player  that was used
///
- (void)playerView:(ExcoPlayerView * _Nonnull)playerView didStartAd:(NSString * _Nonnull)playerID;
...
/// \param playerID The identifier of the player  that was used
///
- (void)playerView:(ExcoPlayerView * _Nonnull)playerView didReachMidpoint:(NSString * _Nonnull)playerID;
...
/// \param playerID The identifier of the player  that was used
///
- (void)playerView:(ExcoPlayerView * _Nonnull)playerView didCompleteAd:(NSString * _Nonnull)playerID;
...
SWIFT_CLASS_NAMED("MiniPlayerConstants")
@interface MiniPlayerConstants : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull topLeft;)
+ (NSString * _Nonnull)topLeft SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull topRight;)
+ (NSString * _Nonnull)topRight SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull bottomLeft;)
+ (NSString * _Nonnull)bottomLeft SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull bottomRight;)
+ (NSString * _Nonnull)bottomRight SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull topBanner;)
+ (NSString * _Nonnull)topBanner SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull bottomBanner;)
+ (NSString * _Nonnull)bottomBanner SWIFT_WARN_UNUSED_RESULT;
@end
