 ...
 */
@interface OMIDExcoAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDExcoPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDExcoPartner *)partner
                               ...
                               resources:(NSArray<OMIDExcoVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
