 ...
 */
@interface OMIDExcoAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDExcoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDExcoAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDExcoAdSessionContext *)context
