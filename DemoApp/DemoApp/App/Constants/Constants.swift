...
struct Constants {
    struct PlayerIdConstants {
        static var playerIdWithAds: String {
            return "85958501-aa63-4317-b103-5ea9f3a276f8"
        }
        static var playerIdWithoutAds: String {
            return "8bd39116-eacb-4b4e-a160-bedd5d71ce1c"
        }
        static var programmaticPlayer = "53b575e4-a511-4181-96bb-284048097968"
    }
    ...
    static var getPredefinedConfiguration: [ExcoPlayerConfiguration] = {
